...
class iscApp1:
 ...
 iscWindow1Title0 =gtk.Label("Label")
...
def iscWindow1():
 ...
 thisiscApp1.iscWindow1DateBox0.set_text("TextBox")
 ...
 thisiscApp1.iscWindow1Window1Fixed.put(thisiscApp1.iscWindow1MainEntry0, 36, 59)
 thisiscApp1.iscWindow1MainEntry0.set_size_request(270, 180)
 thisiscApp1.iscWindow1MainEntry0.show()
 thisiscApp1.iscWindow1Window1Fixed.put(thisiscApp1.iscWindow1ATextField10, 38, 282)
 thisiscApp1.iscWindow1ATextField10.set_size_request(261, 45)
 thisiscApp1.iscWindow1ATextField10.show()
 thisiscApp1.iscWindow1Window1Fixed.put(thisiscApp1.iscWindow1QTextBox0, 40, 250)
 thisiscApp1.iscWindow1QTextBox0.set_text("What did I have for lunch today?")
 thisiscApp1.iscWindow1QTextBox0.set_size_request(264, 22)
 thisiscApp1.iscWindow1QTextBox0.connect("changed", iscWindow1QTextBoxChanged)
 thisiscApp1.iscWindow1QTextBox0.show()
 thisiscApp1.iscWindow1Window1Fixed.put(thisiscApp1.iscWindow1Title0, 91, 29)
 thisiscApp1.iscWindow1Title0.set_size_request(40, 12)
